      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
			...
			<li class="active"><a href="Buchungsliste_FraSpa_.php">FraSpa_old <span class="sr-only">(current)</span></a></li>
...
$sql = "SELECT * FROM Buchungsliste_FraSpa_ ORDER BY id ASC";
...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        echo "<tr><td> ".$row["id"]." </td><td> ".$row["Kunden_Nr"]." </td><td> ".$Buchungsdatum->format('d.m.Y')." </td><td> ".$row["Empfaenger"]." </td><td> ".$row["Verwendungszweck"]." </td><td align='right'> ".number_format($row["Betrag"], 2, ',', '.')." &euro;</td></tr>";
    }
} else {
    //echo "0 results";
}
