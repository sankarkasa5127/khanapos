...
.price-box p{font-size: 15px;}
  ...
  width: 100%;
         ...
         .subitem{
            ...
            <?php  if(in_array( "types" ,$arraypermission )) { ?>
               <!-- <div class="row">
               ...
               <div class="table-responsive">
                  ...
                  <table class="table table-striped tablesorter display dataTable" id='empTable' style="width: 100%;">
                     ...
                     <tbody>
                        <?php 
                           $deviceTypeQry = "select * from device_type";
                           $deviceTypeData = mysqli_query($conn, $deviceTypeQry);
                           while ($row = mysqli_fetch_assoc($deviceTypeData)) { ?>
                              <tr id="">
                                 <td class="text-center"><?= $row['id'] ?></td>
                                 <td class="text-left"><?= $row['name'] ?></td>
                                 <td class="text-left"><?= $row['description'] ?></td>
                                 <td class="text-left"><?= $row['notiz'] ?></td>
                                 <td>
                                    <button type="button" class="btn btn-primary " data-id="<?= $row['id'] ?>" data-name="<?= $row['name'] ?>" data-description="<?= $row['description'] ?>" data-notiz="<?= $row['notiz'] ?>" onclick="viewdata(this)"><i class="fa fa-edit"></i></button>
                                    <button type="button" class="btn btn-danger " onclick="deldata(<?= $row['id'] ?>)"><i class="fa fa-trash"></i></button>
                                 </td>
                              </tr>
                          <?php }
                        ?>
         ...
         <div class="modal fade" id="editDeviceTypemodel" tabindex="-1" role="dialog" aria-labelledby="editDeviceTypeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
               <div class="modal-content">
                  <div class="modal-header">
                     <h5 class="modal-title" id="editDeviceTypeModalLabel">Edit your record</h5>
                  ...
                  <div class="modal-body">
                           <div class="tab-content">
                              <div id="home" class="tab-pane fade in active">
                                 ...
                                 <form id="editDeviceTypeForm" action="javascript:;" enctype="multipart/form-data">
                                    <input type="hidden" name="id" class="roweditid" value="" />
                                    <div class="form-row">
                           <div class="form-group col-md-12">
                              <label for="recipient-name" class="col-form-label">Type Name:</label>
                              <input type="text" class="form-control " class="deviceTypeName" id="typeName" value="" name="name"  required/>
                           </div>
                           <div class="form-group col-md-12">
                              <label for="recipient-name" class="col-form-label">Description:</label>
                              <textarea class="form-control" rows="4" class="deviceTypeDescription" name="description"></textarea>
                           </div>
                           <div class="form-group col-md-12">
                              <label for="recipient-name" class="col-form-label">Notiz:</label>
                              <textarea class="form-control" rows="4" class="deviceTypeNotiz" name="notiz"></textarea>
                           </div>
                           <!-- <div class="form-group col-md-12">
                              <label for="recipient-name" class="col-form-label">Choose Color:</label>
                              <input type="color" class="form-control form-control-color"  name="icon" id="myColor" value="#CCCCCC" title="Choose a color" style="width: 10%;
    height: 36px;">
                           </div>
                            -->
...
">
         ...
         <div class="modal fade" id="addModalLabel" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
               <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <form id="addForm" action="addBusinessType.php" method="POST">
                     
                        <div class="form-row">
                           <div class="form-group col-md-12">
                              <label for="recipient-name" class="col-form-label">Type Name:</label>
                              <input type="text" class="form-control " id="typeName" value="" name="name"  required/>
                           </div>
                           <div class="form-group col-md-12">
                              <label for="recipient-name" class="col-form-label">Description:</label>
                           ...
                           <div class="form-group col-md-12">
                              <label for="recipient-name" class="col-form-label">Notiz:</label>
                              <textarea class="form-control" rows="4" name="notiz"></textarea>
                           </div>
      ...
      <script>
         ...
         function viewdata(deviceInfo) {
           $("#editDeviceTypeForm .deviceTypeName").val($(deviceInfo).attr('data-name'));
           $("#editDeviceTypeForm .deviceTypeDescription").val($(deviceInfo).attr('data-description'));
           $("#editDeviceTypeForm .deviceTypeNotiz").val($(deviceInfo).attr('data-notiz'));
           $('#editDeviceTypemodel').modal('show');
         }
      </script>
