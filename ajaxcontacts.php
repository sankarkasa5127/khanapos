...
if($searchValue != ''){
   ...
   $sel = mysqli_query($conn,"select count(*) as allcount from phoneBook");

$records = mysqli_fetch_assoc($sel);
$totalRecords = $records['allcount'];


$sel = mysqli_query($conn,"select count(*) as allcount  from phoneBook  WHERE 1 ".$searchQuery);
$records = mysqli_fetch_assoc($sel);
...
// ## Fetch records
    ...
    $empQuery = "select * from phoneBook WHERE 1 ".$searchQuery." order by ".$columnName." ".$columnSortOrder." limit ".$row.",".$rowperpage;
 // die;
