...
.price-box p{font-size: 15px;}
  ...
  width: 100%;
         ...
         .subitem{
            ...
            <?php  if(in_array( "roles" ,$arraypermission )) { ?>
               <!-- <div class="row">
               ...
               <div class="modal-content">
                  ...
                  <div class="modal-body">
                           ...
                           <div class="form-group col-md-12">
                              ...
                              <input type="text" class="form-control " id="typeName" value="" name="roleName"  required/>
                           </div>
                           <div class="form-group col-md-12">
         ...
         <div class="modal fade" id="permission" tabindex="-1" role="dialog" aria-labelledby="permissionlabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
               <div class="modal-content">
                  ...
                  <form id="savepermission" action="savepermission.php" method="POST">
                  <input type="hidden" name="roleid" class="roweditid" value="" />
                  <style>
...
.form-row {
  ...
  margin-left: -5px;
                     ...
                     <div class="form-row" id="apendpermissions">
                           <?php //include('modals/roles/addpermissions.php');
                          // include('modals/roles/addpermissionsToggle.php');
                           ?>
                        </div>
                        <button type="submit" class="btn btn-primary" id="addNewRecord">Save </button>
                     </form>
         ...
         <div class="modal fade" id="addModalLabel" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
               <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <form id="addForm" action="addRole.php" method="POST">
                     
                        <div class="form-row">
                           <div class="form-group col-md-6">
                              <label for="recipient-name" class="col-form-label">Role Name:</label>
                              <input type="text" class="form-control "  value="" name="roleName"  required/>
                           </div>
                           <div class="form-group col-md-6">
                              <label for="recipient-name" class="col-form-label">Status :</label>
    ...
    function permission(rowid){
      $(".roweditid").val(rowid);
    
      $.ajax({
                        url: 'modals/roles/addpermissionsToggle.php',
                        type: "POST",
                        data: {'id': rowid},
                        success: function(response) {
                           $('#apendpermissions').html(response);
         ...
         $('#savepermission').validate({
           ...
           submitHandler: function(form) {
             ...
             var form_data = new FormData(document.getElementById("savepermission"));
             $.ajax({
               url: form.action,
               cache: false,
               contentType: false,
      ...
      <script>
         ...
         function viewdata(rowid) {
           $.ajax({
               ...
               data: {'rowId': rowid},
               success: function(response) {
                  $(".roweditid").val(response.roles.id);
               $("#typeName").val(response.roles.roleName);
               $("#status option").filter(function() {
                 
                  return $(this).val() === response.roles.status;
               }).prop("selected", true);
