...
if($searchValue != ''){
   ...
   $sel = mysqli_query($conn,"select count(*) as allcount from _itemType");

$records = mysqli_fetch_assoc($sel);
$totalRecords = $records['allcount'];


$sel = mysqli_query($conn,"select count(*) as allcount  from _itemType  WHERE 1 ".$searchQuery);
$records = mysqli_fetch_assoc($sel);
...
// ## Fetch records
    ...
    $empQuery = "select * from _itemType WHERE 1 ".$searchQuery." order by ".$columnName." ".$columnSortOrder." limit ".$row.",".$rowperpage;
 // die;
