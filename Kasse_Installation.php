...
.price-box p{font-size: 15px;}
  ...
  width: 100%;
         ...
         .subitem{
            ...
            <?php  if(in_array( "Kasse_Installation" ,$arraypermission )) { ?>
               <!-- <div class="row">
               ...
               <div class="modal-content">
                  ...
                  <div class="modal-body">
                           ...
                           <div class="tab-content">
                              ...
                              <label for="recipient-name" class="col-form-label">kunden_nr:</label>
                              <input type="text" class="form-control input-datalist"  list="list-timezone12"  id="kunden_nr"  value="" name="kunden_nr"  required/>
						   ...
						   <div class="form-group col-md-4">
                              ...
                              <input type="text" class="form-control " id="firma"  value="" name="firma"  required/>
                           </div>
						   <div class="form-group col-md-4">
                              <label for="recipient-name" class="col-form-label">anschrift:</label>
                              <input type="text" class="form-control " id="anschrift"  value="" name="anschrift"  required/>
                           </div>
						   <div class="form-group col-md-4">
                              <label for="recipient-name" class="col-form-label">kontakt:</label>
                              <input type="text" class="form-control " id="kontakt"   value="" name="kontakt"  required/>
                           </div>
						   <div class="form-group col-md-4">
                              <label for="recipient-name" class="col-form-label">version:</label>
                              <input type="text" class="form-control " id="version"  value="" name="version"  required/>
                           </div>
						   <div class="form-group col-md-4">
                              <label for="recipient-name" class="col-form-label">termin:</label>
                              <input type="text" class="form-control " id="termin"  value="" name="termin"  required/>
                           </div>
						   <div class="form-group col-md-4">
                              <label for="recipient-name" class="col-form-label">auftraggeber:</label>
                              <input type="text" class="form-control " id="auftraggeber"  value="" name="auftraggeber"  required/>
                           </div>
						   <div class="form-group col-md-4">
                              <label for="recipient-name" class="col-form-label">notiz:</label>
                              <input type="text" class="form-control " id="notiz"  value="" name="notiz"  required/>
                           </div>
                           <div class="form-group col-md-4">
                              <label for="recipient-name" class="col-form-label">Done :</label>
                              <select class="form-select" name="done" id="done" required >
...
">
         ...
         <div class="modal fade" id="addModalLabel" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
               <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <form id="addForm" action="addinstallation.php" method="POST">
                     
                        <div class="form-row">
                           <div class="form-group col-md-4">
                              <label for="recipient-name" class="col-form-label">kunden_nr:</label>
                              <input type="text" class="form-control input-datalist"  list="list-timezone" value="" name="kunden_nr"  required/>
						   ...
						   <div class="form-group col-md-4">
                              <label for="recipient-name" class="col-form-label">firma:</label>
                              <input type="text" class="form-control "  value="" name="firma"  required/>
                           </div>
						   <div class="form-group col-md-4">
                              <label for="recipient-name" class="col-form-label">anschrift:</label>
                              <input type="text" class="form-control "  value="" name="anschrift"  required/>
                           </div>
						   <div class="form-group col-md-4">
                              <label for="recipient-name" class="col-form-label">kontakt:</label>
                              <input type="text" class="form-control "  value="" name="kontakt"  required/>
                           </div>
						   <div class="form-group col-md-4">
                              <label for="recipient-name" class="col-form-label">version:</label>
                              <input type="text" class="form-control "  value="" name="version"  required/>
                           </div>
						   <div class="form-group col-md-4">
                              <label for="recipient-name" class="col-form-label">termin:</label>
                              <input type="text" class="form-control "  value="" name="termin"  required/>
                           </div>
						   <div class="form-group col-md-4">
                              <label for="recipient-name" class="col-form-label">auftraggeber:</label>
                              <input type="text" class="form-control "  value="" name="auftraggeber"  required/>
                           </div>
						   <div class="form-group col-md-4">
                              <label for="recipient-name" class="col-form-label">notiz:</label>
                              <input type="text" class="form-control "  value="" name="notiz"  required/>
                           </div>
                           <div class="form-group col-md-4">
                              <label for="recipient-name" class="col-form-label">Done :</label>
                              <select class="form-select" name="done" required >
                                <option value="">Status....</option>
                                <option value="1">Ja</option>
                                <option value="0">Nein</option>
                              </select>
      ...
      <script>
         ...
         function viewdata(rowid) {
           $.ajax({
               url: 'viewInstallation.php',
               type: "POST",
               dataType: "json",
               data: {'rowId': rowid},
               success: function(response) {
                  $(".roweditid").val(response.Kasse_Installation.id);
               $("#kunden_nr").val(response.Kasse_Installation.kunden_nr);
			   $("#firma").val(response.Kasse_Installation.firma);
			   $("#anschrift").val(response.Kasse_Installation.anschrift);
			   $("#kontakt").val(response.Kasse_Installation.kontakt);
			   $("#version").val(response.Kasse_Installation.version);
			   $("#termin").val(response.Kasse_Installation.termin);
			   $("#auftraggeber").val(response.Kasse_Installation.auftraggeber);
			   $("#notiz").val(response.Kasse_Installation.notiz);
               $("#done option").filter(function() {
                 
                  return $(this).val() === response.Kasse_Installation.done;
               }).prop("selected", true);
