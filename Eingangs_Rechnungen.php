...
?>
            ...
            <?php  if(in_array( "Eingangs_Rechnungen" ,$arraypermission )) { ?>
               <div class="row">
                  ...
                  <div class="modal-body">
                           ...
                           <div class="tab-content">
                              <div id="home" class="tab-pane fade in active">
                                <?php include("modals/Eingangs_Rechnungen/info.php");?>
                                 </div>
                                 <div id="menu1" class="tab-pane fade">
                                
                                 <?php include("modals/Eingangs_Rechnungen/payments.php");?>
                                          
                                 </div>
                                 <div id="menu2" class="tab-pane fade">
                                    <?php include("modals/Eingangs_Rechnungen/documents.php");?>
                                 </div>
                                 <div id="menu3" class="tab-pane fade">
                                   
                                 <?php include("modals/Eingangs_Rechnungen/items.php");?>
                                   
                                 </div>
                                 <div id="menu4" class="tab-pane fade">
                                 <?php include("modals/Eingangs_Rechnungen/persons.php");?>
                                   
                                 </div>
                                 <div id="menu5" class="tab-pane fade">
                                    
                                 <?php include("modals/Eingangs_Rechnungen/contacts.php");?>
                                 </div>
                                 <div id="menu4" class="tab-pane fade">
...
">
                                 ...
                                 <?php include("modals/Eingangs_Rechnungen/status.php");?>
                                 </div>
                                 <div id="menu7" class="tab-pane fade">
                                 <?php include("modals/Eingangs_Rechnungen/invoiceType.php");?>
                                   
                                 </div>
                                 <div id="menu8" class="tab-pane fade">
                                
                                 <?php include("modals/Eingangs_Rechnungen/versand.php");?>
         ...
         <div class="modal-body">
            ...
            <div class="tab-content"  style="height: 421px;">
                  ...
                  <form action="barcodeItemassign.php" method="post" id="assignBarcode" >
                     <div class="form-row align-items-center">
                        ...
                        <div class="row assigndiv" style="display:none;">
                           <div class=" col-md-4">
                              <p class="card-text"><strong>Assign Date</strong>: <input type="date" name='assignDate' id="" data-date="" class="datepicker form-control" data-date-format="DD.m.YYYY" value="<?php echo date('Y-m-d');?>" required/></p>
                           </div>
                           <div class=" col-md-4">
                              <p class="card-text">
               ...
               <input type="hidden" value="" name="invoicerowid" class="invoiceidBarcode"/>
                  ...
                  <input type="date" name='assignDate' id="" data-date="" class="datepicker form-control" data-date-format="DD.m.YYYY" value="<?php echo date('Y-m-d');?>" required/>
                  </div>
                  <div class="form-group col-md-6">
         ...
         <div class="modal fade" id="addModalLabel" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
               <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <form id="addForm" action="addEinInvoice.php" method="POST">
                        <div class="form-row">
                           <div class="form-group col-md-4">
                              <label for="recipient-name" class="col-form-label">Rechnung Nummer:</label>
                              <input type="text" class="form-control " id="rechnung_nummer" name="rechnung_nummer">
                           </div>
                           <div class="form-group col-md-4">
                           ...
                           <div class="form-group col-md-4">
                              <label for="recipient-name" class="col-form-label">Kunden Name:</label>
                              <input type="text" class="form-control " id="kunden_name" name="kunden_name">
                           </div>
                        </div>
                        <div class="form-row">
                           <div class="form-group col-md-4">
                              <label for="recipient-name" class="col-form-label">Betrag Brutto:</label>
                              <input type="text" class="form-control " id="betrag_brutto" name="betrag_brutto">
                           </div>
                           <div class="form-group col-md-4">
                        ...
                        <div class="form-row">
                           ...
                           <div class="form-group col-md-4">
                              ...
                              <input type="text" class="form-control " id="rechnung_datum" name="rechnung_datum">
                           </div>
                           <div class="form-group col-md-4">
      ...
      $(function () {
        ...
        $('#itemsform').on('submit', function (e) {
         ...
         $('#statusInvoice').on('submit', function (e) {
            ...
            $.ajax({
                  type: 'post',
                  url: 'ein_updateInvoiceStatus.php',
...
?>  
'url': 'ajexEingangs_Rechnungen.php?from=<?php echo $_GET['from'];?>&to=<?php echo $_GET['to'];?>'
                  <?php 
               }else{
                  ?>  
                  'url': 'ajexEingangs_Rechnungen.php'
               <?php 
               }
               ?>
