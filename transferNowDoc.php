...
">
         ...
         <div class="modal fade" id="addModalLabel" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
               <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <form id="addForm" action="addType.php" method="POST">
      ...
      <div class="modal fade" id="assignModal" tabindex="-1" role="dialog" aria-labelledby="assignModallabel" aria-hidden="true">
         <div class="modal-dialog  modal-lg" role="document">
            <div class="modal-content" style="">
               <div class="modal-header">
                  <h5 class="modal-title" id="assignModallabel">Assign Kunden. <strong class="showinvoiceId"></strong></h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                  </button>
               </div>
               <div class="modal-body">
                  <form id="assignPayType" action="assignPayType.php" method="POST">
                     <input type="hidden" id="transferid" name="transferid" value="" required />
                     <div class="form-row">
                        <div class="form-group col-md-12">
                        ...
                        <button type="submit" class="btn btn-primary" id="updatePaymentrecord">Assign </button>
      ...
      <script src="http://editor.datatables.net/extensions/Editor/js/dataTables.editor.min.js"></script>
...
$('#assignModal').modal('show');
        ...
        $('#assignPayType').validate({
           ...
           submitHandler: function(form) {
             ...
             $('#addloaderpay').show();
             $.ajax({
               url: 'assignKundenTotransferNow.php',
               contentType: false,
               processData: false,
               type: "POST",
               data: form_data,
