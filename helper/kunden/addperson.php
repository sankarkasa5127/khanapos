...
$result = $conn->query($sql);
    ...
    $Query = "select * from kundenpersons	 WHERE rowid= ".$invoiceid."  ORDER BY `id` DESC";
   ...
   $i=1;
    while ($row = mysqli_fetch_assoc($Records)) {
                  ...
                  echo "<td class='text-center'><button  class=' btn btn-danger' onclick='delperson(".$row['id'].")'><i class='fa fa-trash' aria-hidden='true'></i></button></td>";
                  echo "</tr>";     
                  $i++;
    }    
